...
docker run --hostname $SERVICE_NAME --user "$(id -u):$(id -g)" -it --network bluebasket-net --name $SERVICE_NAME $PORT_ADDRESS -v "/home/${USER}/GitWorld/":"/home/${USER}/GitWorld" "${SERVICE_IMAGE}:latest" /bin/bash;
